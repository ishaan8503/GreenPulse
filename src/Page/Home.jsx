...
return (
    ...
    <nav className="bg-white/60 dark:bg-zinc-700/60 fixed w-full z-20 top-0 start-0 border-gray-200 dark:border-gray-600 mt-5 backdrop-blur-md">
        ...
        <div className='text-xl font-semibold w-[500px] flex flex-row place-content-end '>
            <nav>
                <Link to="/contactus" className='mr-10'>Contact Us</Link>
    ...
    <div className="animate-bounce mx-auto w-full h-8 rounded-lg mt-10 text-xl text-black bg-emerald-300 font-serif font-semibold">
    ...
    <div className="w-full mt-16 ml-20 flex flex-row">
        ...
        <h2 className="  text-5xl font-bold dark:text-white mb-5">
            We strive to protect nature for future generations
        </h2>
        <p className="text-lg font-normal text-gray-400 lg:text-xl dark:text-gray-400 mr-28">
            Revolutionizing the way the renewable sector manages energy.
        </p>
        </div>
    </div>
      ...
      <div className="flex gap-3 ml-10">
        ...
        <img
          className="h-auto max-w-md transition-all duration-300 rounded-2xl border hover:border-none  hover:blur-none"
          src="https://www.wirecable.in/wp-content/uploads/2021/07/41-1.jpg"
          alt="image description"
        />
    ...
    <hr className="w-72 h-1 mx-auto my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-600"></hr>
      ...
      <div className="mt-20 ml-20 mb-5 flex flex-col">
        <h1 className="mx-auto text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          We invest in the{" "}
          <span className="underline underline-offset-3 decoration-8 decoration-green-300 dark:decoration-green-500">
            Green Potential .
          </span>
        </h1>
        <p className="text-xl mr-[25px] mt-5 font-normal text-gray-500  dark:text-gray-400 ">
      ...
      <footer className="bg-white rounded-lg shadow ml-20 mr-20 mt-10 mb-8 dark:bg-gray-800">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          ...
          <ul className="flex flex-wrap items-center mt-3 text-md font-medium text-gray-500 dark:text-gray-400 sm:mt-0 gap-5" >
            <li>
              <a
